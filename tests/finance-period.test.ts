...
it("a schedule set before today's local cutoff does not skip a full cycle",()=>{expect(nextPayoutCutoff("WEEKLY","America/Chicago",new Date("2026-03-09T13:00:00Z"))).toEqual(new Date("2026-03-09T14:00:00Z"));expect(nextPayoutCutoff("WEEKLY","America/Chicago",new Date("2026-03-09T14:00:00Z"))).toEqual(new Date("2026-03-16T14:00:00Z"));});
