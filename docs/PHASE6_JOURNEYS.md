...
The gallery also retains masked viewport screenshots after twelve Tab presses inside navigation and after Escape restores focus, at all six widths for visitor, customer, host and community pages. These allow a separate manual visual review of recorded focus states. Keyboard execution remains automated in Actions; live human keyboard and assistive-technology testing is not represented by these artifacts.
