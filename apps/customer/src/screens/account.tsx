...
export function EmailSignIn() {
  ...
  return <Page title="Sign in with linked email"><Hint>Use an email already verified and linked to your account. This fallback does not create or merge accounts. New customers start with phone verification.</Hint><Field label="Email address" value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" autoComplete="email" />
