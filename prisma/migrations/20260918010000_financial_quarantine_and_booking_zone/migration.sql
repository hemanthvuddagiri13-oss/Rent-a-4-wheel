...
CREATE TABLE "FinancialCase" (
 ...
 "operationId" TEXT, "refundId" TEXT, "kind" TEXT NOT NULL, "amountCents" INTEGER NOT NULL,
...
WHERE (d."stripePaymentIntentId" IS NOT NULL OR d."status" <> 'REQUIRES_PAYMENT') AND NOT EXISTS
...
FROM "SecurityDeposit" d JOIN "Reservation" r ON r."id"=d."reservationId" WHERE d."legacyUncertain";
