...
export default auth(async (req) => {
  ...
  // Native handlers own the ID shared by their body, response header and log.
  // Next middleware response headers otherwise overwrite the handler's ID.
  // Proxy rejections above still carry their own matching body/header pair.
