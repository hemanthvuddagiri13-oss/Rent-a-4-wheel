...
export type FinanceProviderObject={id:string;operationKey:string;kind:string;hostId:string;accountId:string;status:string;amount:number;currency:string;amountReversed:number;detailsSubmitted?:boolean;chargesEnabled?:boolean;payoutsEnabled?:boolean;currentlyDue?:string[];eventuallyDue?:string[];disabledReason?:string|null;taxStatus?:string};
export type FinancePayload={hostId:string;country?:string;batchId?:string;accountId?:string;amount?:number;currency?:string;transferId?:string;reversalId?:string;metadata?:Record<string,string>};
