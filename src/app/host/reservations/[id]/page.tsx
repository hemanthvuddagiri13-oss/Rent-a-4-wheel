...
export default async function HostTripPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!r) notFound();
  return <Workspace eyebrow="Host trip workspace" title={r.confirmationNumber}><HostNav /><TripConnections reservationId={id} /><TripConsole reservationId={id} /></Workspace>;
}
